                    ...
                    <div class="col-md-5" style="background: #e5e5e5;padding-top: 15px;    padding-bottom: 37px;">
                      <div class="col-md-12">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" name="rate" id="rate" placeholder="VND or %">
                              </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" name="" placeholder="Giá tiền VND (<=)">
                              </div>
