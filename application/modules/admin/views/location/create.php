                   ...
                   <div class="clearfix"></div>
                    <div class="col-md-6">
                           <div class="form-group">
                              <label for="select-standard" class="control-label col-md-3">Vị Trí</label>
                               <div class="col-md-9">
                              <input type="text" name="city" class="form-control" placeholder="Hội An" value="<?php echo @$location->city;?>">
                            </div>
                    ...
                    <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <div class="col-md-8">
                                <input type="text" name="longitude" class="form-control" placeholder=""  value="<?php echo @$location->longitude;?>">
                            </div>
                     ...
                     <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <div class="col-md-8">
                                <input type="text" name="latitude" class="form-control" placeholder="" value="<?php echo @$location->near;?>">
                            </div>
                    ...
                    <div class="col-md-6">
                           <div class="form-group">
                              <label for="select-standard" class="control-label col-md-3">khu Vực</label>
                               <div class="col-md-9">
                              <input type="text" name="" class="form-control" placeholder="Nhập tên khu vực cách nhau bằng dấu ,">
                            </div>
