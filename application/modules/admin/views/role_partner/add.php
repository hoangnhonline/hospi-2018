            ...
            <div class="col-md-12">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title">THÊM QUYỀN ADMIN ĐỐI TÁC</h3>
                    ...
                    <div class="col-md-7">
                      <div class="col-md-3">
                        <div class="form-group">
                              <label for="select-standard" class="font-weight-unset">Mã công ty</label>
                        ...
                        <div class="col-md-9">
                        <div class="form-group">
                              <label for="select-standard" class="font-weight-unset">Tên công ty</label>
                              <input type="text" name="" class="form-control">
                      ...
                      <div class="clearfix"></div>
                       <div class="col-md-12 text-center">
                         <button class="btn-tim" style="padding-right: 20px;padding-left: 20px;padding-top: 10px;padding-bottom: 10px">Thêm quyền admin đối tác</button>
                       </div>
                   </div>
                    <div class="col-md-5">
